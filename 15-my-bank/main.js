...
class Coustomer extends Bank {
    ...
    gender;
    mobileNum;
    constructor(name, age, gender, mobileNum, accountNumber, balance) {
...
async function Main() {
    ...
    while (isContinue) {
        ...
        while (!accountNumber) {
            ...
            accountNumber = CoustomerAccounts.find((account) => account.accountNumber === AskAccountNumber.accountNum);
            if (!accountNumber) {
        ...
        let BankAccount = new Bank(accountNumber.accountNumber, accountNumber.balance);
        let options = [
            "DEPOSIT MONEY: ",
            "WITHDRAW MONEY: ",
            "CHECK BALANCE: ",
        ...
        while (true) {
            ...
            switch (choices.choice) {
                case "DEPOSIT MONEY: ":
                    ...
                    console.log(chalk.red.bold.italic(`\t(1):A TAX OF 10 RUPEES WILL BE APPLIED ON DEPOSITS OF 1000 RS OR MORE.`));
                    console.log(chalk.red.bold.italic(`\t(2):A TAX OF 100 RUPEES WILL BE APPLIED ON DEPOSITS OF 10000 RS OR MORE.\n`));
