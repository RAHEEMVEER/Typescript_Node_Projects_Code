...
async function drivingLicence() {
    ...
    while (wantToContinue) {
        ...
        if (input.choices === "LICESNCE OFFICE:") {
                ...
                let mcqs = await inquirer.prompt([
                    {
                        ...
                        message: "WHICH OF THE FOLLOWING DOCUMENTS IS TYPICALLY REQUIRED TO OBTAIN A DRIVING LICENSE?",
                    },
                    {
                        name: "mcq2",
                        type: "list",
                        ...
                        message: "IN MOST COUNTRIES, AT WHAT AGE ARE INDIVIDUALS TYPICALLY ELIGIBLE TO APPLY FOR A LEARNER'S DRIVING LICENSE?",
                    },
                    {
                        name: "mcq3",
                        type: "list",
                        ...
                        message: "WHAT TYPE OF TEST IS COMMONLY REQUIRED TO OBTAIN A DRIVING LICENSE?",
                    },
                ]);
                if (mcqs.mcq1 === "PASSPORT:" &&
            ...
            console.log(chalk.yellow.bold.italic(`  CREATOR BY ==> `) +
